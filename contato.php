  ...
  <header class="header" data-header>
    <div class="container">
        ...
        <nav class="navbar" data-navbar>
            ...
            <a href="TCC Definitivo(index).html" class="logo">
        ...
        <a href="TCC Definitivo(login).html" class="btn btn-tertiary">
        ...
        <section class="hero text-center" aria-label="home" id="home">
            ...
            <ul class="hero-slider" data-hero-slider>
                ...
                <li class="slider-item active" data-hero-slider-item>
                    ...
                    <div class="slider-bg">
                        <img src="Imagens TCC/_biblioteca2.jpg" width="1880" height="950" alt="" class="img-cover">
                    </div>
                ...
                <li class="slider-item" data-hero-slider-item>
                    ...
                    <div class="slider-bg">
                        <img src="Imagens TCC/img.jpg" width="1880" height="950" alt="" class="img-cover">
                    </div>
            ...
            <li>
              <div class="event-card has-before hover:shine">
                ...
                <div class="card-banner img-holder" style="--width: 350; --height: 450;">
                  <img src="Imagens TCC/_livro4.jpg" width="350" height="450" loading="lazy"
