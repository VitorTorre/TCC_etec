...
<body>
    ...
    <div class="container">
        ...
        <div class="product-info">
            <img src="22-11-2024/imgs/peter-pan.jfif" alt="Produto">
            <div class="details">
                <h2>Peter pan</h2>
                <p>Preço Unitário: R$ 22,90</p>

                <label for="quantidade">Quantidade:</label>
                <input type="number" id="quantidade" name="quantidade" min="1" value="1" onchange="atualizarPreco()">

                <p id="preco-total">Preço Total: R$ 22,90</p>
            </div>
        </div>

        <div class="buttons">
            <a href="finalizacao4.php"><button class="btn" onclick="finalizarCompra()">Finalizar Compra</button></a>
